module {
  hw.module @top_module(in %clk : i1, in %rst : i1, in %in_data : i4, out out_data : i4) {
    ...
    %interconnect5 = llhd.sig %false_10 : i1
    ...
    %c0_i4_11 = hw.constant 0 : i4
    %11 = llhd.prb %interconnect2 : !hw.inout<i4>
    %12 = comb.concat %c0_i4_11, %11 : i4, i4
    %u3.out_data = hw.instance "u3" @module3(clk: %8: i1, reset: %9: i1, valid: %10: i1, in_data: %12: i8) -> (out_data: i8)
    ...
    %u4.out_data, %u4.done = hw.instance "u4" @module4(clk: %14: i1, reset: %15: i1, valid: %16: i1, ready: %17: i1, in_data: %18: i8) -> (out_data: i8, done: i1)
  ...
  hw.module private @module3(in %clk : i1, in %reset : i1, in %valid : i1, in %in_data : i8, out out_data : i8) {
    %false = hw.constant false
    %clk_0 = llhd.sig name "clk" %false : i1
    %0 = llhd.prb %clk_0 : !hw.inout<i1>
    %false_1 = hw.constant false
  ...
  hw.module private @module4(in %clk : i1, in %reset : i1, in %valid : i1, in %ready : i1, in %in_data : i8, out out_data : i8, out done : i1) {
    %false = hw.constant false
    %clk_0 = llhd.sig name "clk" %false : i1
    %0 = llhd.prb %clk_0 : !hw.inout<i1>
    %false_1 = hw.constant false
